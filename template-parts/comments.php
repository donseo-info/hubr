...
$comment_form_allowed = get_setting( 'account.not_pro.add_comments' ) || ! theme_container()->get( Membership::class )->is_expired();

?>
<div>

    <div class="comments-title"><?php echo __( 'Comments:', 'wpcommunity' ) ?> <?php echo get_comments_number() ?></div><!-- .comments-title -->
        ...
        'must_log_in' => sprintf(
            ...
            /* translators: %s: Login URL. */
                ...
                add_query_arg(
                    ...
                    get_permalink( get_setting( 'page.profile' ) )
                )
            )
        ),
    ];
