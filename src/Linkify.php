...
class Linkify {
    ...
    /**
     * Add links to text.
     * https://github.com/misd-service-development/php-linkify/blob/master/src/Misd/Linkify/Linkify.php
     *
     ...
     */
    public function linkify( $text, $urls = true, $emails = true, array $options = [] ) {
