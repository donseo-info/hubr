...
<div class="wrap wpshop-settings-wrap">
    ...
    <div class="wpshop-settings-head">
        <div class="wpshop-settings-head__title">
            <?php echo THEME_NAME ?>
            <sup style="font-size: .7em"><?php echo THEME_ORIGINAL_VERSION ?></sup>
        </div>
        <?php /*
 ...
 */ ?>
        <?php if ( $settings->use_localized_settings() ): ?>
            <div>
                <?php echo __( 'Settings Scope', 'wpcommunity' ) ?>:
                <?php
        ...
        <?php endif ?>
        <div>
            <a href="<?php echo add_query_arg( 'setup-assistant', 1, get_settings_url() ) ?>">
                <?php echo __( 'Setup Assistant', 'wpcommunity' ) ?>
            </a>
        </div>
        <div class="wpshop-settings-head__support">
            <a href="<?php echo $settings->doc_link( 'doc' ) ?>" target="_blank" rel="noopener">
    ...
    <div class="wpshop-settings-notices">
        <h1 class="screen-reader-text"><?php echo __( 'Settings' ) ?></h1><?php /* point for script wp-admin/js/common.js:1087 */ ?>
        ...
        <div class="wpshop-settings-container__sidebar">
            <div class="wpshop-settings-sidebar-inner">
                ...
                <div class="wpshop-settings-box">
                    <?php echo __( 'Theme Version:', 'wpcommunity' ) ?>
                    <?php echo THEME_ORIGINAL_VERSION ?>
                </div>
